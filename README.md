...
o	Job titles
o	Departments
o	Relevant signature context
•	Eliminated weeks of manual review
•	Enabled leadership to build accurate organizational and communication maps
•	Now reusable for ongoing strategic and operational analysis
...
________________________________________
Installation
Add the code to clone the repo
pip install -r requirements.txt
________________________________________
Usage
# Phase 1: scan root folders
python phase1_scan_folder.py

# Phase 1: scan only subfolders
python phase1_scan_subfolders_only.py

# Phase 2: consolidate and enrich data
